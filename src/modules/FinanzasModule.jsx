...
const SUB_TABS = [['pl', 'P&L'], ['egresos', 'Proyección Egresos']]
    ...
    <>
      ...
      {currentER && (
        <div style={{ marginBottom: 10, display: 'flex', alignItems: 'center', gap: 10 }}>
          <span style={{ fontSize: 10, textTransform: 'uppercase', letterSpacing: 2, color: 'rgba(26,31,54,0.5)', fontWeight: 700 }}>{currentER.monthLabel}</span>
        ...
        <DataTable
          ...
          columns={[
            ...
            { key: 'margenNeto', label: 'Margen', align: 'right', render: v => (
              <span style={{ color: v > 0.3 ? ACCENT : v > 0.15 ? 'rgba(26,31,54,0.7)' : DANGER, fontWeight: 600 }}>
                {fmtPct(v)}
              </span>
            )},
